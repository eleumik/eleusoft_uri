/*
 * $Header: /cvsrep/fd/WEB-INF/classes/org/eleusoft/uri/apache/URIUtil.java,v 1.1 2007/07/10 18:19:30 mik Exp $
 * $Revision: 1.1 $
...
public class URIUtil {
    ...
    /**
     * Escape and encode a string regarded as the fragment component of an URI with
     * a given charset.
     * <p><blockquote><pre>
	 * fragment         = *( pchar / "/" / "?" )
	 * </pre></blockquote><p>
     ...
     * @see #encode
     */
    public static String encodeFragment(String unescaped, String charset) {

        return encode(unescaped, URI.allowed_fragment, charset);
    }
     ...
     */
    private static class Coder extends URI {
